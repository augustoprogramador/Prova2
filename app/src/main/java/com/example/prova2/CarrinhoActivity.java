    ...
    public void onClick(View view) {
        if(view.getId() == R.id.btn_fechar_pedido){
            if(txt_endereco_entrega.getText().equals("") ||formaPagamento.equals("") || carrinhos.size() == 0){
                ...
                Pedido newPedido = new Pedido("0", txt_carrinho_valor_total.getText().toString(), idUsuario, PegaNomesProdutos(), formaPagamento, txt_endereco_entrega.getText().toString(), PegaIdsProdutos());
                Pedido pedido = bdPedido.inserePedido(newPedido);
                ...
                Intent i = new Intent(this, DetalhesPedidoActivity.class);
                i.putExtra("ID_PEDIDO", pedido.getId());
                startActivity(i);
            }
        }
    }
