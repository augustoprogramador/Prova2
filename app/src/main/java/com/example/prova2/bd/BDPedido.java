...
public class BDPedido extends SQLiteOpenHelper {
    ...
    public Pedido findByID(String query_id){
        Pedido pedido = null;
        Cursor cursor = db_write.query("tb_pedido", new String[]{"_id", "valorFinal, idUsuario, nomesProdutos, formaPagamento, enderecoEntrega, idsProduto"}, "_id=?", new String[]{query_id}, null, null, null);
        ...
        if(cursor.moveToFirst()){
            ...
            String idsProdutos = cursor.getString(cursor.getColumnIndexOrThrow("idsProduto"));

            pedido = new Pedido(id, valorFinal, idUsuario, nomesProdutos, formaPagamento, enderecoEntrega, idsProdutos);
        }
        cursor.close();
    ...
    public Pedido inserePedido(Pedido pedido) throws SQLiteException {
        ...
        new_values.put("idsProduto", pedido.getIdsProdutos());
    ...
    public ArrayList<Pedido> findAll(String idQuery){
        ...
        Cursor cursor = db_write.query("tb_pedido", new String[]{"_id", "valorFinal, idUsuario, nomesProdutos, formaPagamento, enderecoEntrega, idsProduto"}, "idUsuario=?", new String[]{idQuery}, null, null, null);
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                pedidos.add(new Pedido(id, valorFinal, idUsuario, nomesProdutos, formaPagamento, enderecoEntrega, idsProdutos));
